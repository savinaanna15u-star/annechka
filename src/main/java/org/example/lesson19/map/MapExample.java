...
// при добавлении элемента в HashMap, мы всегда высчитываем хеш код ключа и по нему делаем остаток от деления
// (hash % количество ячеек в таблице)
// на количство ячеек в хеш таблице и получаем номер ячейки => не важен порядок добавления в Мар