...
// автомарное действие - действие, которое выполняется в одно действие(для процессора)
// операция инкремента — это увеличение значения переменной на 1 с помощью оператора ++